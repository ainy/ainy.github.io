...
def _join_lemmas(lemmas, links):
    ...
    <link_types>
        ...
        <type id="6">PRTF-PRTS</type> короток - короткий
        <type id="7">NAME-PATR</type> имя - отчество
        <type id="8">PATR_MASC-PATR_FEMN</type> отчество муж - жен
        <type id="9">SURN_MASC-SURN_FEMN</type> фамилия муж - жен
        <type id="10">SURN_MASC-SURN_PLUR</type> фамилия муж - множ
        ...
        <type id="14">PATR_FEMN_FORM-PATR_FEMN_INFR</type> михална-михайловна
        <type id="15">ADJF_eish-SUPR_nai_eish</type> яснейший - наияснейший
        <type id="16">ADJF-SUPR_ajsh</type> короткий - кратчайший
        <type id="17">ADJF_aish-SUPR_nai_aish</type> кратчайший-наикратчайший
